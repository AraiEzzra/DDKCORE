...
var Accounts = {
  ...
  InsertStakeOrder: 'INSERT INTO stake_orders ("id","status","startTime","nextMilestone","endTime","senderId","freezedAmount","milestoneCount") VALUES (${account_id},${status},${startTime},${nextMilestone},${endTime},${senderId},${freezedAmount},${milestoneCount}) ',
