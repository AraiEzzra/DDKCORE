...
let Accounts = {
	...
	getMigratedList: 'select m."address",e."username",m."totalFrozeAmount" from migrated_etps_users e INNER JOIN mem_accounts m ON(e."address" = m."address" AND e.transferred_etp = 1) LIMIT ${limit} OFFSET ${offset}'
};
