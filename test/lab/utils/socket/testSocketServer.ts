...
import { TEST_RUNNER_PORT, TEST_SOCKET_SERVER_CONFIG } from 'test/lab/utils/socket/config';
...
export default new TestSocketServer(TEST_RUNNER_PORT, TEST_SOCKET_SERVER_CONFIG);
