...
const constants: IConstants = {
    ...
    TIMEOUT_START_SYNC_BLOCKS: 1000000,
    TIMEOUT_START_PEER_REQUEST: 1000000,
    PEER_CONNECTION_TIME_INTERVAL_REBOOT: {
        MIN: 9 * 60 * 1000,
        MAX: 12 * 60 * 1000,
    },
    PEER_PING_PONG_INTERVAL: 500,
    PEERS_COUNT_FOR_DISCOVER: 1,
    PRE_MINED_ACCOUNTS: [
    ...
    TIMEOUT_START_PEER_CONNECT: 1000000,
    ...
    START_FEATURE_BLOCK: {
        ...
        FRAUD_OPERATION_BLACKLIST_BLOCK_HEIGHT: 0,
        VERIFY_STAKE_TRANSACTION_BLOCK_HEIGHT: 0,
    },
    CORE_REQUEST_TIMEOUT: 300,
    WHITELIST: {
