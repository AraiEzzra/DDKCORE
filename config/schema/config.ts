export default {
    config: {
        ...
        required: ['address', 'version', 'minVersion', 'fileLogLevel', 'logFileName', 'consoleLogLevel', 
            'trustProxy', 'topAccounts', 'db', 'api', 'peers', 'broadcasts', 'transactions', 'forging', 
            'loading', 'ssl', 'dapp', 'cacheEnabled', 'redis']
    }
};
